...
GUT v9.x est requis pour Godot 4.2+. Ce dossier doit contenir l'addon complet avant de pouvoir
exécuter les tests headless.

## Option 1 — Via l'AssetLib de l'éditeur Godot

1. Ouvrir le projet dans l'éditeur Godot 4.
2. Aller dans AssetLib (onglet en haut).
3. Rechercher "GUT" et installer la version 9.x.
